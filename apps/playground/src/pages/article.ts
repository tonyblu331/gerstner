export function render(): string {
  return `
  <div class="page-article" style="padding-bottom:4rem">
    <div class="art-progress"></div>

    <header class="art-topbar" role="banner">
      <div class="g-shell art-topbar__inner">
    ...
    <main>
      <section class="g-shell art-header">
        <div class="g-content art-header__content g-stack-2" style="--g-max-width: 42rem;">
          <div class="art-kicker">Technology</div>
      ...
      <section class="g-shell art-hero-wrap">
        <figure class="g-content" style="--g-max-width: 59rem; margin: 0;">
          <img class="art-hero__img" src="https://picsum.photos/seed/nyt-art/945/480" alt="Jason Allen's A.I.-generated work" />
          <figcaption class="art-hero__caption">
        ...
        <div class="g-full g-sub art-body-grid">
          <article class="art-body col-from-content-start col-end-9">
            ...
            <blockquote class="art-pullquote">
              <p>We're watching the death of artistry unfold right before our eyes.</p>
            </blockquote>
            <p class="art-body__p">Mr. Allen, 39, defended his process. He said he had spent more than 80 hours refining his prompts in Midjourney — adjusting phrasing, curating hundreds of iterations, then upscaling and editing the final image in Photoshop before printing. &quot;It's not just typing words,&quot; he said. &quot;It's curation, it's taste, it's vision.&quot;</p>
            <p class="art-body__p">But for many working artists, that distinction hardly matters. They argue that tools like Midjourney and DALL-E were trained on billions of images scraped from the internet — including their own copyrighted work — without consent or compensation. The U.S. Copyright Office has <a href="#">so far refused to grant copyright</a> to purely A.I.-generated works, creating new uncertainty for collectors and creators alike.</p>
            <p class="art-body__p">The Colorado State Fair stood by its decision. The judges, who did not know Midjourney was used, said they evaluated the piece on its aesthetic merits and awarded it fairly under the digital art rules, which do not prohibit A.I. tools. Still, after the controversy, they said they would clarify rules for next year.</p>
            <p class="art-body__p">Mr. Allen said he has no plans to apologize. He has since made thousands of dollars selling prints of &quot;Théâtre d'Opéra Spatial&quot; and is working on a graphic novel using A.I. imagery. &quot;Art has always evolved with technology,&quot; he said. &quot;The paint tube once scandalized artists, too.&quot;</p>
      ...
      <section class="g-shell art-endmatter" id="comments">
        <div class="g-content g-stack-3" style="--g-max-width: 42rem;">
          ...
          <div>
            ...
            <div class="g art-related__grid">
              <article class="col-4 g-stack-1">
    ...
    <footer class="art-footer">
      <div class="g-shell">
        <div class="g-content art-footer__inner g-stack-3">
          <div class="art-footer__logo">The New York Times</div>
          <div class="g art-footer__nav">
            <div class="col-2">
